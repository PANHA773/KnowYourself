      ...
      <Container>
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <label className="hidden items-center gap-2 rounded-md px-2 py-1 text-sm text-slate-200 md:flex">
              <span className="sr-only">{i18n.t("nav.language")}</span>
              <select
                value={i18n.lang}
                onChange={(e) => i18n.setLang(e.target.value)}
                className="rounded-xl border border-white/10 bg-white/5 px-2 py-1 text-sm text-slate-100"
        ...
        {open ? (
          <div className="md:hidden">
            <nav className="surface fade-in mb-4 grid gap-1 p-2">
              ...
              <div className="mt-2 flex items-center justify-between rounded-xl border border-white/10 bg-white/5 p-2">
